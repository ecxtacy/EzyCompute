  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-slate-100 to-primary-50">
      ...
      <div className="max-w-7xl mx-auto px-6 py-4 flex gap-6">
        <Link to="/" className="text-primary-600 hover:text-primary-800 text-sm font-medium inline-flex items-center gap-1 transition-colors">
          &larr; Back to Home
        </Link>
        <Link to="/pi-estimator" className="text-primary-600 hover:text-primary-800 text-sm font-medium inline-flex items-center gap-1 transition-colors">
          📐 Pi Estimator
        </Link>
      </div>
